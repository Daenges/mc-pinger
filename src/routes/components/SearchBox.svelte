            ...
            <form action="" class="w-full">
                <table class="md:h-14 md:text-xl sm:text-sm rounded-xl" style="font-family: minecraft-regular;">
                    ...
                    <tr class="mt-5">
                        ...
                        <td class="w-1/6 h-full"><button on:click|once={() => buttonPressed=true}  on:click={() => startSearch=validateInput()} class="text-white w-full h-full bg-black focus:bg-gray-800 border-2 border-black rounded-r-xl font-bold py-2 md:text-xl sm:text-sm">Search</button></td>
                    </tr>
                </table>
            </form>
        </div>
